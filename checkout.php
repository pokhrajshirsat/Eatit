...
<body>
    <div class="topnav" id="myTopnav">
        ...
        <a href="service.html" id="service ">Service<i class="fas fa-user-friends "></i></a>
...
for($i=0; $i<count($cart); $i++) {
	mysqli_query($con, 'insert into orders(id, quantity)
values('.$cart[$i]->id.',  '.$cart[$i]->quantity.')');
}
...
?>
Thanks for buying products. Click <a href="menu.php">here</a> Reorder 
